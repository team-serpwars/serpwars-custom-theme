...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        'key' => 'group_5c512db6edb9c',
        'title' => 'General Pages',
        'fields' => array(
            array(
                'key' => 'field_5c512db6f364e',
                'label' => 'Basic Info',
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
    ...
    acf_add_local_field_group(array(
        'key' => 'group_5b7d3e6d9ce06',
        'title' => 'Icon Field',
        'fields' => array(
            array(
                'key' => 'field_5b7d3eaec7784',
                'label' => 'icon',
                'name' => 'fontawsome-icon',
                'type' => 'font-awesome',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array(
        'key' => 'group_5de300a9d151f',
        'title' => 'Location Pages',
        'fields' => array(
            array(
                'key' => 'field_5de3012fdbc20',
                'label' => 'Basic Info',
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
            ...
            array(
                'key' => 'field_5de302abe5e64',
                'label' => 'Content Description 2',
                'name' => 'content_description_2',
                'type' => 'wysiwyg',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                ...
                'conditional_logic' => array(
                    array(
                        array(
                            'field' => 'field_5de302a4e5e63',
                            'operator' => '!=empty',
                        ),
                        array(
                            'field' => 'field_5de302abe5e64',
                            'operator' => '!=empty',
                        ),
                    ),
                ),
            ...
            array(
                'key' => 'field_5de484db0c463',
                'label' => 'Content Image 3',
                'name' => 'content_image_3',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5de302bbe5e66',
                'label' => 'Content Description 3',
                'name' => 'content_description_3',
                'type' => 'wysiwyg',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'conditional_logic' => array(
                    array(
                        array(
                            'field' => 'field_5de302b7e5e65',
                            'operator' => '!=empty',
                        ),
                        array(
                            'field' => 'field_5de302bbe5e66',
                            'operator' => '!=empty',
                        ),
                    ),
                ),
            ...
            array(
                'key' => 'field_5de484e10c464',
                'label' => 'Content Image 4',
                'name' => 'content_image_4',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5de302c5e5e68',
                'label' => 'Content Description 4',
                'name' => 'content_description_4',
                'type' => 'wysiwyg',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'conditional_logic' => array(
                    array(
                        array(
                            'field' => 'field_5de302c2e5e67',
                            'operator' => '!=empty',
                        ),
                        array(
                            'field' => 'field_5de302c5e5e68',
                            'operator' => '!=empty',
                        ),
                    ),
                ),
            ...
            array(
                'key' => 'field_5de484e40c465',
                'label' => 'Content Image 5',
                'name' => 'content_image_5',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5de3036acc2f1',
                'label' => 'Content Title 5',
            ...
            array(
                'key' => 'field_5de3036dcc2f2',
                'label' => 'Content Description 5',
                'name' => 'content_description_5',
                'type' => 'wysiwyg',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
